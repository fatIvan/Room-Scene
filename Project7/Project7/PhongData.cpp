...
void MySetupLights()
{
    ...
    myLights[0].SpecularColor.Set(0.3, 0.3, 0.3);   // Very light gray
    myLights[0].IsEnabled = false;                   // BE SURE TO ENABLE YOUR LIGHTS

    // Second light (light #1)
    myLights[1].AmbientColor.Set(0.4, 0.4, 0.13);    // Yellow color
    myLights[1].DiffuseColor.Set(0.7, 0.7, 0.2);    // Yellow
    myLights[1].SpecularColor.Set(0.3, 0.3, 0.3);   // White
...
void MySetupMaterials()
{
    ...
    myMaterials[0].SpecularColor.Set(0.3, 0.3, 0.3);
    ...
    myMaterials[1].DiffuseColor.Set(0.6f, 0.4f, 0.4f);
    myMaterials[1].SpecularColor.Set(0.3, 0.3, 0.3);
    ...
    myMaterials[2].SpecularColor.Set(0.3, 0.3, 0.3);
